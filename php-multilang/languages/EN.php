...
$EN = [
    ...
    "other_questions" => "<h1>Other issues</h1> In practice, other issues outside the above areas are encountered, which are easily resolved by our professional team.",
